...
class TopK(CustomOp):
    ...
    def __init__(
        ...
        *,
        ...
        self.fused_shared_experts_scaling_factor = fused_shared_experts_scaling_factor
    ...
    def forward_native(
        ...
        *,
        ...
        return select_experts(
            ...
            fused_shared_experts_scaling_factor=self.fused_shared_experts_scaling_factor,
        )
